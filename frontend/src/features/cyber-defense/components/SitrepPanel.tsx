...
export default function SitrepPanel({
     ...
     return (
          <div className="h-full w-full bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 rounded-lg overflow-hidden flex flex-col shadow-lg">
               {/* Header */}
               ...
               <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 sm:space-y-5">
                    ...
                    <div className="space-y-3 pb-4 border-b border-slate-800">
                         <div className="bg-slate-950/50 border border-slate-800 rounded-lg p-3 sm:p-4">
                              <div className="flex items-center gap-2 mb-2">
                                   ...
                                   <h4 className="font-mono text-xs sm:text-sm text-slate-300">
                                        CONSENS MEDIA:
                                   </h4>
                              </div>
                              <p className="text-[11px] sm:text-xs text-slate-400 leading-relaxed mb-3">
                                   {explicatieConsens || "Așteptare date..."}
                              </p>
                    ...
                    {factChecks && factChecks.length > 0 && (
                         <div className="pb-4 border-b border-slate-800">
                              <h4 className="font-mono text-xs sm:text-sm text-slate-300 mb-3 flex items-center gap-2">
                                   <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-500 flex-shrink-0" />{" "}
                                   FACT CHECKS OFICIALE:
                              </h4>
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-2 sm:gap-3 pb-4 border-b border-slate-800">
                         ...
                         <div className="w-full">
                              <h4 className="font-mono text-xs sm:text-sm text-slate-300 mb-2">
                                   COGNITIVE MANIPULATION PATTERNS:
                              </h4>
                              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                                   {(emotions || ["Analiză în curs"]).map(
                                        (emo, idx) => (
                                             <span
                                                  key={idx}
